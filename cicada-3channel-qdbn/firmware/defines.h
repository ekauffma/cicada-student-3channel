...
typedef ap_fixed<18,8> conv_linear_table_t;
...
typedef ap_ufixed<10,6,AP_RND_CONV,AP_SAT> layer12_t;
typedef ap_fixed<18,8> relu1_table_t;
typedef ap_fixed<26,14> dense2_accum_t;
typedef ap_fixed<26,14> layer13_t;
typedef ap_fixed<12,4> weight13_t;
