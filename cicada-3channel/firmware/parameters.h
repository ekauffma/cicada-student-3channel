...
// concat_inputs
struct config4 : nnet::concat_config {
    static const unsigned n_elem1_0 = 252;
    static const unsigned n_elem1_1 = 1;
    static const unsigned n_elem1_2 = 0;
    static const unsigned n_elem2_0 = 252;
...
struct config6_mult : nnet::dense_config {
    ...
    typedef conv_replacement_accum_t accum_t;
...
struct linear_config7 : nnet::activ_config {
    ...
    typedef conv_replacement_linear_table_t table_t;
};
...
struct config10 : nnet::dense_config {
    ...
    static const unsigned n_nonzeros = 3796;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    static const bool store_weights_in_bram = false;
