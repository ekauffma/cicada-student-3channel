...
cicada_3channel = load_model("/hdfs/store/user/aloeliger/CICADA2026Models/3channel_vae_student", compile=False)
for i, layer in enumerate(cicada_3channel.layers):
...
def convert_to_hls4ml_model(keras_model, hls_config):
    hls_model = hls4ml.converters.convert_from_keras_model(
        ...
        io_type="io_parallel",
        output_dir="cicada-3channel-vae",
