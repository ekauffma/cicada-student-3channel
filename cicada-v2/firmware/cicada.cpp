...
void cicada(
    ...
    #pragma HLS INTERFACE ap_vld port=input_main,layer13_out 
    #pragma HLS DATAFLOW 
    ...
    if (!loaded_weights) {
        ...
        nnet::load_weights_from_txt<bn1_scale_t, 16>(s9, "s9.txt");
        nnet::load_weights_from_txt<bn1_bias_t, 16>(b9, "b9.txt");
    ...
    nnet::normalize<layer8_t, layer9_t, config9>(layer8_out, layer9_out, s9, b9); // bn1

    layer10_t layer10_out[N_LAYER_7];
    #pragma HLS ARRAY_PARTITION variable=layer10_out complete dim=0
    nnet::relu<layer9_t, layer10_t, relu_config10>(layer9_out, layer10_out); // relu1
    ...
    nnet::linear<layer11_t, layer12_t, linear_config12>(layer11_out, layer12_out); // dense2_linear

    nnet::relu<layer12_t, result_t, relu_config13>(layer12_out, layer13_out); // outputs
